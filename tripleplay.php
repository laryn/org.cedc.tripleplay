  ...
  public function __construct() {
    ...
    $this->_columns = array(
      ...
      'civicrm_contact_c' => array(
        ...
        'fields' => array(
          ...
          'contact_type_c' => array(
            'title' => ts('Contact Type (Contact C)'),
            'name' => 'contact_type',
          ),
          'contact_sub_type_c' => array(
            'title' => ts('Contact Subtype (Contact C)'),
            'name' => 'contact_sub_type',
          ),
        ),
        'filters' => array(
      ...
      'civicrm_relationship_type_c' => array(
        ...
        'fields' => array(
          'label_a_c' => array(
            'title' => ts('Relationship A-C '),
            'default' => TRUE,
          ),
          'label_c_a' => array(
            'title' => ts('Relationship C-A '),
            'default' => TRUE,
          ),
        ),
        'grouping' => 'relation-fields',
      ...
      'civicrm_relationship_c' => array(
        'dao' => 'CRM_Contact_DAO_Relationship',
        'fields' => array(
          'start_date' => array(
            'title' => ts('Relationship C Start Date'),
          ),
          'end_date' => array(
            'title' => ts('Relationship C End Date'),
          ),
          'description' => array(
            'title' => ts('Description C'),
          ),
          'relationship_id' => array(
            'title' => ts('Rel C ID'),
            'name' => 'id',
        ...
        'filters' => array(
          'is_active' => array(
            'title' => ts('Relationship C Status'),
            'operatorType' => CRM_Report_Form::OP_SELECT,
            'options' => array(
              '' => '- Any -',
              1 => 'Active',
  ...
  public function from() {
    $this->_from = "
        FROM civicrm_relationship {$this->_aliases['civicrm_relationship']}
             ...
             INNER JOIN civicrm_contact {$this->_aliases['civicrm_contact_c']}
                        ON ( {$this->_aliases['civicrm_relationship_c']}.contact_id_b =
                             {$this->_aliases['civicrm_contact_c']}.id )
